/*
Deployment script for CarsWebsiteDatabase
...
GO
:setvar DatabaseName "CarsWebsiteDatabase"
:setvar DefaultFilePrefix "CarsWebsiteDatabase"
...
GO
PRINT N'Creating [dbo].[Users].[IX_ApplicationUser_NormalizedUserName]...';


GO
CREATE NONCLUSTERED INDEX [IX_ApplicationUser_NormalizedUserName]
    ON [dbo].[Users]([NormalizedUsername] ASC);


GO
PRINT N'Creating [dbo].[Users].[IX_ApplicationUser_NormalizedEmail]...';
...
GO
PRINT N'Creating [dbo].[UsersRoles]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Images]...';


GO
ALTER TABLE [dbo].[Images]
    ADD FOREIGN KEY ([CarId]) REFERENCES [dbo].[Cars] ([CarId]);


GO
PRINT N'Creating unnamed constraint on [dbo].[UsersRoles]...';
